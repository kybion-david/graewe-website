...
Umami Cloud is operated by **Umami Software, Inc. (San Francisco, USA)**; there is no documented EU-only region, and the DPA covers EEA transfers via Standard Contractual Clauses. Datenschutz §4 discloses this. If you ever claim EU hosting in that copy, verify it against the current DPA first — an earlier draft asserted it wrongly.
